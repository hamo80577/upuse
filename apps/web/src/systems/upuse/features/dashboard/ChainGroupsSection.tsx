              ...
              >
                ...
                >
                  ...
                  <Stack direction="row" spacing={0.8} sx={{ flexWrap: "wrap", rowGap: 0.8 }}>
                    ...
                    {group.totals.upuse > 0 ? (
                      <Chip
                        size="small"
                        label={`UPuse ${group.totals.upuse}`}
                        sx={{
                          fontWeight: 800,
                    ...
                    {group.totals.shortClosures > 0 ? (
                      <Chip
                        size="small"
                        label={`shortClosures ${group.totals.shortClosures}`}
                        sx={{
                          fontWeight: 800,
                          bgcolor: "rgba(255,241,242,0.95)",
                          color: "#be123c",
                    ...
                    {group.totals.issues > 0 ? (
                      <Chip
                        size="small"
                        label={`issues ${group.totals.issues}`}
                        sx={{
                          fontWeight: 800,
                    ...
                    {group.totals.inactive > 0 ? (
                      <Chip
                        size="small"
                        label={`inactive ${group.totals.inactive}`}
                        sx={{
                          fontWeight: 800,
                          bgcolor: "rgba(248,250,252,0.96)",
                          color: "#475569",
                    ...
                    {group.totals.offHours > 0 ? (
                      <Chip
                        size="small"
                        label={`offHours ${group.totals.offHours}`}
                        sx={{
                          fontWeight: 800,
                          bgcolor: "rgba(248,250,252,0.96)",
                          color: "#475569",
                    ...
                    {group.totals.highDemand > 0 ? (
                      <Chip
                        size="small"
                        label={`highDemand ${group.totals.highDemand}`}
                        sx={{
                          fontWeight: 800,
                          bgcolor: "rgba(255,247,214,0.95)",
                          color: "#92400e",
