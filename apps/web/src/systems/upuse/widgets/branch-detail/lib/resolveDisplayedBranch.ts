...
export function resolveDisplayedBranch(
  ...
  return {
    ...
    availabilityKind: liveBranch.availabilityKind,
    ...
    vssBucket: liveBranch.vssBucket,
    vssGroup: liveBranch.vssGroup,
    vssNextOpeningAt: liveBranch.vssNextOpeningAt,
    vssEndTime: liveBranch.vssEndTime,
